...
const projects = [
    {
        name: "Lock API",
        description: "Lock uses REST APIs to protect endpoints by using two techniques: tokens and sessions.",
    ...
    },
    {
        ...
        description: "Affable manages your Blog through REST API and you can also see others' Blogs.",
...
projectButtons.forEach((button, index) => {
    button.addEventListener("click", () => {
        ...
        popupTechnologies.innerHTML = projects[index].technologies.map(tech => `<li>${tech}</li>`).join("");
